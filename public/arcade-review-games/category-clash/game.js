(() => {
  ...
  function startGame(){
    ...
    state={soundOn:state?.soundOn!==false,mode:document.querySelector('input[name="playMode"]:checked')?.value||'classroom',scores:data.teams.map(()=>0),activeTeam:0,completed:{},current:null,powerWager:null,finalWagers:[],finalResults:[],individualCorrect:0,individualAnswered:0};
